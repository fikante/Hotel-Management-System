...
const API_BASE_URL =
  "https://api.mockfly.dev/mocks/9ca538d3-0aee-4b52-9a2c-1eda2c988c83";
    ...
    const loadDashboardData = async () => {
      ...
      try {
        ...
        const [
          ...
          fetchData(
            "/api/dashboard/transactions/average",
        ...
        setAverageTransactionAmount(
          transactionAvgData.averageTransactionAmount || 0
        );
    ...
    <div className="bg-gray-50 min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
          <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-2xl transition-shadow duration-300 flex flex-col justify-between h-48">
            <div>
              <h2
          ...
          <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-2xl transition-shadow duration-300 flex flex-col justify-between h-48">
            <div>
              ...
              <p className={`${metricValueStyle} text-green-600`}>
          ...
          <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-2xl transition-shadow duration-300 flex flex-col justify-between h-48">
            <div>
              ...
              <div className="flex items-center">
                <p className={`${metricValueStyle} text-yellow-600`}>
          ...
          <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-2xl transition-shadow duration-300 flex flex-col justify-between h-48 overflow-hidden">
            <div>
              <h2
                className={`${subHeadingStyle} flex items-center justify-between mb-1`}
              >
                Average Transaction Amount{" "}
                <FaMoneyBillAlt className="text-indigo-500 ml-2 size-20" />
              </h2>
              <p className={`${metricValueStyle} text-indigo-600`}>
          ...
          <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="mb-4">
              <Doughnut
                ...
                options={guestDemographicsChartOptions}
                height={300}
              />
            </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-500 ml-2">
                        ({geo.adults} Adults, {geo.children} Children)
                      </span>
                    </div>
                  </div>
                </li>
