...
const AddRoom = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12 w-full md:w-4/5">
          ...
          <div className="flex flex-col md:flex-row gap-x-5">
            <div className="w-full md:w-48 max-w-md p-6 bg-white rounded-lg ">
              {file ? (
                ...
                >
                  {/* Add Room Image Text */}
                  <p className="text-gray-700 text-sm font-medium mb-2">Add Room Image</p>
