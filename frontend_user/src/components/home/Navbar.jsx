        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className={`flex space-x-6 ${isScrolled ? 'text-gray-700' : 'text-white'}`}>
              <a href="#" className="hover:text-primary transition-300 font-medium">Home</a>
              <a href="#about" className="hover:text-primary transition-300 font-medium">About Us</a>
              <a href="#contact" className="hover:text-primary transition-300 font-medium">Contact</a>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white mt-2 py-4 px-4 rounded-lg shadow-lg animate-fade-in">
            <div className="flex flex-col space-y-3">
              <a href="#" className="text-gray-700 hover:text-primary py-2 transition-300">Home</a>
              <a href="#about" className="text-gray-700 hover:text-primary py-2 transition-300">About Us</a>
              <a href="#contact" className="text-gray-700 hover:text-primary py-2 transition-300">Contact</a>
